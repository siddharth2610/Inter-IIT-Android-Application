package com.abhishek.interiit2016.loader;
...
public class PandaLoadingView extends DialogFragment {

    public PandaLoadingView() {
    }
    ...
    @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (mDialog == null) {
            ...
            mDialog.setContentView(R.layout.pandaloading_main);
